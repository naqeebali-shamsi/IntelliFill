...
describe('Templates Page', () => {
  ...
  describe('Template List', () => {
    ...
    it('displays empty state when no templates', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/no templates created/i)).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Create Template', () => {
    ...
    it('creates template with valid data', async () => {
      ...
      // Wait for either the mutation to be called or toast to show
      await waitFor(
        () => {
      ...
      // Check the first argument (data) contains expected fields
