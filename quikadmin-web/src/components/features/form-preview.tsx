 ...
 * 
 * Displays a preview of the filled form before download.
 * Shows field values, confidence scores, and validation warnings.
 */

import { useState } from 'react';
import { Eye, Download, AlertCircle, CheckCircle, Loader2 } from 'lucide-react';
...
export function FormPreview({
  ...
  const getFieldValue = (formFieldName: string): string => {
    ...
    const value = documentData[mapping.documentField];
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Review field mappings and values before downloading
            </CardDescription>
          </div>
          {downloadUrl && (
            <Button
