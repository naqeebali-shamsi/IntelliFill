/**
 * GoogleAuthButton - Sign in with Google OAuth
 *
 * Uses Supabase OAuth provider to handle Google authentication.
 * Redirects to Google, then back to /auth/callback for processing.
 */
