  ...
  'inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden',
  {
    variants: {
      variant: {
        ...
        // Solid semantic status variants
        success:
        ...
        error:
          'border-transparent bg-error text-white [a&]:hover:bg-error/90 focus-visible:ring-error/20 dark:focus-visible:ring-error/40',
        // Muted/light semantic status variants
        'success-muted':
          'bg-success-light text-success-foreground border-success/20 [a&]:hover:bg-success-light/80',
        'warning-muted':
          'bg-warning-light text-warning-foreground border-warning/20 [a&]:hover:bg-warning-light/80',
        'error-muted':
          'bg-error-light text-error-foreground border-error/20 [a&]:hover:bg-error-light/80',
        'info-muted':
          'bg-info-light text-info-foreground border-info/20 [a&]:hover:bg-info-light/80',
      },
    },
    defaultVariants: {
      variant: 'default',
