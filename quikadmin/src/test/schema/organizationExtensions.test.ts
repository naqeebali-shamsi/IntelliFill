...
describe('Organization Schema Extensions (Task 380)', () => {
  ...
  describe('Organization.slug field', () => {
    ...
    it('should allow slug with valid URL-safe characters', async () => {
      const validSlugs = ['test-org-123', 'test_org', 'test-org', 'testorg', 'test-org-2024'];
  ...
  describe('Organization.memberships relation', () => {
    ...
    it('should query organization without memberships', async () => {
      const mockOrg = {
        ...
        slug: 'test-org',
        status: 'ACTIVE',
        memberships: [] as { id: string; userId: string; organizationId: string; role: string }[],
        createdAt: new Date(),
        updatedAt: new Date(),
      };
  ...
  describe('Backward compatibility', () => {
    it('should create organization with only required fields (post-migration)', async () => {
      const mockOrg = {
        id: 'org-1',
        name: 'Test Organization',
