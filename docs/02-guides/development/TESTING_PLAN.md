...
**Category 4: Government Forms**
10. USCIS.gov (https://www.uscis.gov/)
    - Immigration forms
11. IRS.gov (https://www.irs.gov/)
    - Tax forms

**Category 5: E-commerce**
12. Amazon (https://www.amazon.com/ap/register)
    - Account creation, checkout
13. eBay (https://www.ebay.com/)
14. Shopify checkout forms

**Category 6: Social Media**
15. Facebook (https://www.facebook.com/reg/)
    - Registration form
16. Twitter/X (https://twitter.com/i/flow/signup)
17. Instagram (https://www.instagram.com/accounts/emailsignup/)

**Category 7: Banking & Finance**
18. Generic bank forms (demo sites)
19. PayPal (https://www.paypal.com/us/webapps/mpp/account-selection)

**Category 8: Generic HTML Forms**
20. W3Schools form examples
21. Local test HTML file
