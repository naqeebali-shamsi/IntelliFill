...
│   │
│   ├── 📄 system-overview.md ⭐⭐⭐ (TRUTH - 41KB, in 01-current-state/architecture/)
│   │   ├── Executive Summary
...
│   │
│   ├── 📄 quick-reference.md ⭐ (9KB, 5-min read, in 01-current-state/architecture/)
│   │   ├── 30-Second Summary
...
```
docs/01-current-state/architecture/system-overview.md (read in full, 30-60 min)
...
2. docs/01-current-state/architecture/system-overview.md (architecture truth)
...
```
CHECK docs/01-current-state/architecture/system-overview.md
  ↓
...
|------|------|---------|------------------|
| **system-overview.md** | 41KB (1,205 lines) | Architecture truth | Weekly (code changes) |
| **quick-reference.md** | 9KB (266 lines) | Fast overview | Monthly |
...
**New developer:** Start with `01-current-state/architecture/quick-reference.md` (5 min), then `01-current-state/architecture/system-overview.md` (30 min)

**Experienced developer:** Jump straight to `01-current-state/architecture/system-overview.md`

**Claude Code:** Read `CLAUDE.md` + `01-current-state/architecture/system-overview.md`
...
**For actual architecture:** Always read `docs/01-current-state/architecture/system-overview.md`

### "How do I know if a feature exists?"

1. Check `docs/01-current-state/architecture/system-overview.md` first
