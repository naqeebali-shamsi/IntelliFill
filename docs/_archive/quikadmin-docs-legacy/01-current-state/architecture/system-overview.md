...
**Important:** The vision in `docs/04-future-vision/architecture/system-architecture.md` represents future enterprise goals at 100k+ users scale, not current implementation. Always refer to this document (`docs/01-current-state/architecture/system-overview.md`) for actual architecture.
