...
**Questions?** Check [01-current-state/architecture/system-overview.md](../01-current-state/architecture/system-overview.md) for authentication service implementation details.
