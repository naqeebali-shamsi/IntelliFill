...
router.post('/admin/users', authenticateSupabase, authorizeSupabase(['admin']), (req, res) => {
...
router.delete('/admin/users/:id', dualAuthenticate, dualAuthorize(['admin']), (req, res) => {
...
router.get('/api/documents/:id', authenticateSupabase, async (req, res) => {
...
router.get('/api/stats/dashboard', optionalAuthSupabase, async (req, res) => {
