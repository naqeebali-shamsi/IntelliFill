...
interface IntelligenceService {
  ...
  suggestMappings(sourceData: ExtractedData, targetSchema: FormSchema): Promise<MappingSuggestion[]>
...
interface ValidationService {
  ...
  validateCrossFields(data: Record<string, any>, rules: CrossFieldRule[]): Promise<ValidationResult>
